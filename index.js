...
app.post('/feedback-form', async (req, res) => {
    try {
        ...
        if (subject.length < 3) {
            ...
            return res.status(400).json({ 
                success: false,
                error: 'Please enter a more detailed subject (minimum 3 characters)' 
            });
        }
        ...
        const adminMailOptions = {
            ...
            to: CONTACT_EMAIL,
            replyTo: email,
            subject: `New Feedback: ${feedbackType} - ${subject}`,
            html: `
                <!DOCTYPE html>
                <html>
                <head>
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div style="text-align: center; margin-bottom: 20px;">
                                <span style="background: #97d700; color: white; padding: 5px 15px; border-radius: 20px; font-weight: bold;">
                        ...
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <div class="feedback-box">
                                    <p style="margin:0;"><strong>Your feedback summary:</strong></p>
